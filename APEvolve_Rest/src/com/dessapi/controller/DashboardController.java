	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		{			
			...
			if( srcParam==null || srcParam.equals("") || srcParam.equals("null")) {
				...
				Map<String, ArrayList<String>> scoreMap = null;//new EvaluationDao().getEvaluationScore(compName);		 
				...
				Map<String, ArrayList<String>> scoreMap = null;//new EvaluationDao().getEvaluationCatScore(compName, cat);
